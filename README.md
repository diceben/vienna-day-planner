...
Statische Website mit 70 Orten in Wien. Läuft ohne Server-Software, ohne Build-Schritt und ohne Abhängigkeit von Claude.

## Kategorien

| Schlüssel | Anzeige | Inhalt |
|---|---|---|
| `fruehstueck` | Frühstückscafés | Kaffeehäuser, in denen man frühstückt |
...
30 der 60 Orte haben derzeit ein Foto, alle von Wikimedia Commons unter freier Lizenz. Urheber und Lizenz stehen je Bild in [bilder/BILDNACHWEIS.md](bilder/BILDNACHWEIS.md). Diese Datei gehört mit veröffentlicht, weil die Lizenzen eine Nennung verlangen. Für Cafés, Clubs und die meisten Aktivitäten gibt es auf Commons nichts Brauchbares, dort hilft nur ein eigenes Foto.
...
|---|---|
| Frühstückscafé | 1 |
| Restaurant · Sehenswürdigkeit · Aktivität | 2 |
| Museum · Musik · Event | 3 |

**Ganztag 8 Punkte · Morgens bis mittags 4 · Nur Abend 5.** Höchstens ein Frühstück, zwei Museen, zwei Restaurants, ein Konzert. Ein Ganztag enthält mindestens ein Café und ein Restaurant; fehlt eine dieser Kategorien in der Auswahl, fragt die Seite vor dem Rechnen nach.
...
Der Umkreis braucht einen aktiven Standort und wirkt je nach Lage sehr unterschiedlich: Vom Stephansdom aus liegen 58 der 70 Orte in drei Kilometern, von Penzing aus vier. Reicht es nicht für die Pflichtkategorien, sagt die Seite das und schlägt vor, den Umkreis wegzulassen.
